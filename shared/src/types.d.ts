...
export type VisualizationType = 'structured-view' | 'mind-map' | 'flowchart' | 'knowledge-graph' | 'uml-class' | 'uml-sequence' | 'uml-activity' | 'executive-dashboard' | 'timeline' | 'gantt' | 'comparison-matrix' | 'priority-matrix' | 'raci-matrix' | 'terms-definitions';
...
export type TaskType = 'tldr' | 'executiveSummary' | 'entityExtraction' | 'relationshipDetection' | 'sectionSummary' | 'signalAnalysis' | 'vizRecommendation' | 'kpiExtraction' | 'glossary' | 'qa' | 'mindMapGeneration';
