...
export type TaskType = 'tldr' | 'executiveSummary' | 'entityExtraction' | 'relationshipDetection' | 'sectionSummary' | 'signalAnalysis' | 'vizRecommendation' | 'kpiExtraction' | 'glossary' | 'qa' | 'mindMapGeneration' | 'argumentMapGeneration' | 'uml-extraction';
